# REST API Breaking Changes for GitHub Enterprise Server 3.21

For more information about GitHub REST API versioning, see "[API Versions](https://docs.github.com/rest/overview/api-versions)".
